...
export const content: any = [
	...
	},
	{
		title: "Gaming",
		color: "#000000",
		src: config.basePath + "/Assets/Images/cluster-images/Gaming.jpg",
		eventDetails: [
			{
				title: "Valorant",
				details: {
					description: [
						"With 18 playable characters, each with unique abilities, Valorant is a power packed, strategy focussed, multiplayer online video game that is sure to grind strategy and shooting skills of a team as a whole and each player as an individual.",
					],
					link: [
						"https://docs.google.com/forms/d/e/1FAIpQLSf-Kq2vheuj-C3CTpQCOlEUV86eRRnaqURfrsJwUWn5N1Te5Q/viewform",
					],
					format: [
						"Team size: 5+2 ( 5 Main players, 2 Substitutes )",
						"It will be a knockout tournament till the semi-finals.",
						"The semis and finals will be the best of three.",
						"Moderators will be spectating the match, and any inconvenience should be brought to the moderators.",
						"Teams will go through a toss to choose the map and for deciding the attacker and the defender.",
						"The moderator of the match will conduct the toss.",
						"The winner of the toss gets the chance to ban the first map and the other team gets the next chance to ban another map. This will go on until one map is left, which will automatically be the map being played.",
						"The loser of the toss gets to choose either defending or attacking.",
					],
					rules: [
						"Players are expected to use a single account for each player.",
						"Each team must consist of 5 players and 2 substitute players.( 5 Players are mandatory. Substitutes are optional.)",
						...
						"The captains will be responsible for adding their team players into the game lobby. Add your teammates in your friend-list well ahead of the match.",
						"Cheating in any form (including exploiting bugs) will not be tolerated and will lead to the disqualifying of the entire team from the event. Team captains must send a screenshot of the final scorecard to the coordinator at the end of the match, for future reference.",
			...
			},
			{
				...
				details: {
					description: [
						"Being a combination of soccer and vehicular mayhem, Rocket League is a competitive game where each team's victory depends on teamwork and outmanoeuvring the opponents.",
					],
					link: [
						"https://docs.google.com/forms/d/e/1FAIpQLSef02o2EMXBFLHRHSOHIggp2NOuKsSQoapKGulI-hfiY_ZsyA/viewform",
					],
					format: [
						"Team size: 3+1 ( 3 Main players, 1 substitute is optional)",
						"It will be a knockout tournament till the semi-finals.",
						"The semis and finals will be the best of three.",
						"Match timer will be set for three minutes.",
						"Moderators will be spectating the match, and any inconvenience should be brought to the moderators.",
						"In case of any dispute, the decision of the moderators is final.",
					],
					rules: [
						"Players are expected to use a single account for each player.",
						"Each team must consist of 3 players and 1 substitute player.( 3 Players are mandatory. Substitutes are optional.)",
						"Substitutes can be included only at the beginning of a new match. The moderator has to be informed about the substitutes included.",
						"Players must be available at least 10 minutes in the lobby before the match is scheduled to begin.",
						"Failure of the entire team to show up on time will lead to forfeiture of the match, and the opponents automatically get a walkover.",
						"Rocket League’s tournament mode will be used to conduct all matches and decide fixtures.",
						"Cheating in any form (including exploiting bugs) will not be tolerated and will disqualify the entire team from the event. Team captains must send a screenshot of the final scorecard to the coordinator at the end of the match for future reference.",
						"Only the base (vanilla) version of the game is to be used (i.e., no mods of any sort).",
						"In case of any changes in the schedule of matches, team captains will be informed.",
						"The coordinator will inform the team leader of match fixtures, tournament schedules and other updates regarding further stages of the tournament.",
					],
					prizes: [
						"1st Place - 69420",
						"2nd Place - 69420",
			...
			},
			{
				...
				details: {
					description: [
						"With teamwork and position at its core, FIFA is a fun and addictive game that surely is loved by football fans.",
					],
					link: ["https://forms.gle/NFxW4hxz8rAha5qp9"],
					format: [
						"A team will consist of 2 players + subs.",
						...
						"Each match will consist of 5 fixtures with each participant playing one fixture against each of the opposing 2 participants before a 2 v 2 match",
						"This equates to 3 fixtures per participant per match.",
						"The outcome of a single match is determined by the aggregate score of the 5 individual fixtures.",
					],
					rules: [
						"All matches should be played via a ´Friendly Match´",
						"Only tactical defense is permitted i.e. defending should always be fully manual, same as attacking.",
						"Standard formations only. It's forbidden to use custom formations i.e. don’t use the square button to change the position of players.",
						"During the round-robin stages, each team will be awarded 3 points for an aggregate scoreline victory, one point for a draw and no points for a defeat.",
						"Round robin group positions will be decided by points, then goal difference, then goals scored, then goals against, and then the head-to-head result against that team in the group. In the unlikely event that teams are still equal when all this is taken into account, then progression to the knockout stages shall be settled with a one-off fixture between 2 nominated players.",
						"Should a match finish as a draw for the knockout rounds a one-off fixture between two elected players will be played, should that fixture finish as a draw, penalties will decide.",
						"It is allowed to change your team during the tournament but not during fixtures",
						"If a fixture in a match is unfulfilled the aggregate score of the fixtures that have been played will decide the match score if the fixture cannot be rescheduled.",
			...
			},
			{
				...
				details: {
					description: [
						"With an engaging storyline, Tekken is a fun and engaging wrestling game that emphasises a lot on your combat skills and spontaneity.",
					],
					link: ["https://forms.gle/Sp8WALFHN2hE4tsp8"],
					format: [
						"The game will be played in 1v1 ‘versus battle’ mode",
						"The entire event will be a Knockout Round and the player winning all the matches will be the ultimate winner of the event.",
					],
					rules: [
						"All the matches will be in “1v1 versus battle” mode.",
						"Players cannot change their characters mid-game.",
						"If player(s) do not show up for his or her match, a walkover to the next round will be awarded to the opposing player.",
						"Demand for a rematch will not be entertained under any circumstances.",
						"Game Mode: Versus Battle",
			...
			},
			{
				...
				details: {
					description: [
						"With exciting fight sequences and floppy characters, Gang Beasts is a fun game to start with. The game is all about beating the other players up and its this simplicity that serves as food for the addiction around it.",
					],
					link: ["https://forms.gle/CxizUi7jGZGYSndE9"],
					format: [
						"It is a team event. Each team consists of 2 players.",
						"A ‘match’ will consist of 2 teams playing against each other for 5 rounds. The team that wins the most rounds out of the 5 are declared the winners. (best of 5)",
						"All the rounds will be a 2v2 match.",
						"The tournament will be a knockout tournament.",
					],
					rules: [
						"For a team to win a round, all the players of the other team must be thrown off the map or fall off on their own.",
						"Before each team’s first match, they will be given 2 minutes to get used to the mechanics of the game. Controller inputs will be taught to the players.",
						"In the unlikely event of a draw after all 5 rounds are over, a 6th round will be conducted to decide the winner.",
						"Demand for a rematch will not be entertained under any circumstances.",
						"Each player can be part of one only one team.",
						"Game mode: Gang- Team deathmatch",
						"Match duration: 5-10 mins",
						"Maps : Vents, Gondola, Blimp, Buoy, Train, Containers",
					],
					prizes: [
						"1st Place - 69420",
						"2nd Place - 69420",
